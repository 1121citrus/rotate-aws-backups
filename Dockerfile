...
# Builds supercronic from source with Go 1.26.4, which patches:
...
FROM golang:1.27rc2-alpine AS supercronic-builder
ARG SUPERCRONIC_VERSION=v0.2.45
...
# Install supercronic binary compiled with Go 1.26.4 (patches CVE-2026-32280,
